...
<table>
  <tr>
    <td>
      <ul>
        <li>
          <strong>Generative AI Developer</strong> •<strong> 12× Hackathon Winner</strong> • <strong>Founding Engineer</strong>
        </li>
...
| SDE Intern | [@Heizen](https://heizen.work) | Fast software delivery agency |
| AD-HOC | [@Citrea](https://citrea.xyz) | ZK Rollups on Bitcoin |
| Builder | [@Vexa](https://github.com/vexa-ai) | Building Zeta, a PM agent for startups |

---

### Achievements
- 12× Global Hackathon Winner  
